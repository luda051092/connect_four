...
/** Connect four
 * 
 * Player1 and player2 take turns dropping circular pieces down the
 * column of their choice. A player wins when they achieve four pieces in a row
 * either vertically, horizontally, or diagonnally. If the board fill up with no
